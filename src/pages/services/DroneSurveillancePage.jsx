...
import { ArrowLeft, Satellite, CheckCircle, Clock, Euro } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">
              {t('droneSurveillanceTitle')}
            </h1>
            
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              {t('droneSurveillanceDesc')}
            </p>
              ...
              {[1, 2, 3, 4, 5].map((index) => (
                <div key={index} className="bg-gray-800/50 p-6 rounded-2xl">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3">
                    {t(`droneSurveillanceFeature${index}`)}
                  </h3>
                </div>
              ))}
            </div>
              ...
              {[1, 2, 3, 4].map((index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300 text-lg">
                    {t(`droneSurveillanceBenefit${index}`)}
                  </p>
                </div>
              ))}
            </div>
