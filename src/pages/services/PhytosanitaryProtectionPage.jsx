...
import { ArrowLeft, Shield, CheckCircle, Clock, Euro } from 'lucide-react';
import { Link } from 'react-router-dom';

const PhytosanitaryProtectionPage = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">
              {t('phytosanitaryProtectionTitle')}
            </h1>
            
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              {t('phytosanitaryProtectionDesc')}
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 leading-relaxed text-center">
              {t('phytosanitaryProtectionOverview')}
            </p>
          </div>
        </div>
      </section>
              ...
              {[1, 2, 3, 4, 5].map((index) => (
                <div key={index} className="bg-gray-800/50 p-6 rounded-2xl">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3">
                    {t(`phytosanitaryProtectionFeature${index}`)}
                  </h3>
                </div>
              ))}
            </div>
              ...
              {[1, 2, 3, 4].map((index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300 text-lg">
                    {t(`phytosanitaryProtectionBenefit${index}`)}
                  </p>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-800/50 p-8 rounded-2xl text-center">
                ...
                <p className="text-xl text-gray-300">
                  {t('phytosanitaryProtectionDuration')}
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 p-8 rounded-2xl text-center">
                ...
                <p className="text-xl text-gray-300">
                  {t('phytosanitaryProtectionPrice')}
                </p>
              </div>
            </div>
          </div>
...
export default PhytosanitaryProtectionPage;
